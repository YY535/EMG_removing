...
%
% This function intends to give you a general view of the effect, therefore
% we reduce the number of nFFT when the recording gets longer. Please
% recompute the spectrum if you want a higher frequency precision. 
% 
